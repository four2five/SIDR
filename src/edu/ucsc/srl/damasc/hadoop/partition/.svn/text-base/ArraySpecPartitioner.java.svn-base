  ...
  */
  public void setConf(Configuration conf) { 
    ...
    System.out.println("recordDim: " + this._recordDimension + 
                       ...
                       " outputSpace: " + HadoopUtils.arrayToString(this._outputSpace) + 
  ...
  public int getPartition(K key, V value, int numPartitions) {
    ...
    //this._tempRecordSize = HadoopUtils.stepSizeForShape( this._recordDimension, this._numReducers, this._outputSpace);
    ...
    /*
    if( this._random.nextFloat() > 0.99 || this._retVal > 0) { 
      System.out.println("gid: " + HadoopUtils.arrayToString(this._tempArray) + 
                       " tempRecord: " + this._tempRecordSize + 
                       " divisor: " + this._recordDimensionDivisor + 
                       " part: " + this._retVal 
                       //" strides: " + HadoopUtils.arrayToString(this._strides)
                       );
    }
    */ 
