 ...
 */
public class ArrayBasedFileSplit extends InputSplit implements Writable, Comparable<ArrayBasedFileSplit> {
...
private static final Log LOG = LogFactory.getLog(ArrayBasedFileSplit.class);
  ...
  public ArrayBasedFileSplit() {
    this._hasReducerDependencyInfo = false;
  }
  ...
  */
  ...
  @Override
  public boolean hasReducerDependencyInfo() { 
    return this._hasReducerDependencyInfo;
  }
   ...
   */
  @Override
  public int compareTo(ArrayBasedFileSplit o) {
    ArrayBasedFileSplit temp = o;
    int retVal = 0;
