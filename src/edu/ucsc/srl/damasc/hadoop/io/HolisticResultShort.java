...
private static final Log LOG = LogFactory.getLog(HolisticResultShort.class);
   ...
   */
  public HolisticResultShort(int neededCount) throws Exception {
    this._values = new short[neededCount];
    this._currentCount = 0;
    this._full = false;
    this._final = false;
  }
   ...
   * definitive result
   */
  public HolisticResultShort(int neededCount, short value) throws Exception {
    this._values = new short[neededCount];
    this._currentCount = 0;
    this._full = false;
    this._final = false;
   ...
   */
  public void clear() {
    Arrays.fill(this._values, (short)0);
    this._currentCount = 0;
    this._full = false;
    this._final = false;
  }
  ...
  public void setNeededCount(int neededCount) {
    short[] newArray = new short[neededCount];
   ...
   */
  public void setFinal(short inValue) throws IOException {
    //System.out.println("start, setFinal: [0] = " + this._values[0] + " inValue: " + inValue);
    this._values = new short[1]; // free up the now useless ._values array
   ...
   */
  public void setHolisticResultShort(short[] values) throws IOException {
   ...
   * @param result the HolisticResultShort object to use to initialize this
   * object
   */
  public void setHolisticResultShort( HolisticResultShort result) throws IOException {
    this.setHolisticResultShort( result.getValues());
    this.setFinal(result.isFinal());
  }

  /**
   * Merges a HolisticResultShort object into this HolisticResultShort object
   * @param result the HolisiticResult object to merge into this object
   */
  public void merge( HolisticResultShort result ) {
    try { 
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    this._values = new short[localArraySize];
