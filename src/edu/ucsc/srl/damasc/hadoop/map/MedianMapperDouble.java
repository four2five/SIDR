...
/**
 */
public class MedianMapperDouble extends Mapper<ArraySpec, MultiVarData, ArraySpec, HolisticResultDouble> {

  @SuppressWarnings("unused")
private static final Log LOG = LogFactory.getLog(MedianMapperDouble.class);
 ...
 */
  public void map(ArraySpec key, MultiVarData inMVD, Context context)
    ...
    try {
      ...
      HolisticResultDouble result = new HolisticResultDouble(extShapeSize);
      ...
      while( dataItr.hasMoreGroups() ) { 
        ...
        while( dataItr.groupHasMoreValues() ) { 
          tempVal = dataItr.getNextValueDouble();
          //result.setValue(dataItr.getNextValueDouble());
      ...
      System.out.println("Caught an exception in MedianMapperDouble.map()" + e.toString() );
      e.printStackTrace();
    }
  }
}
