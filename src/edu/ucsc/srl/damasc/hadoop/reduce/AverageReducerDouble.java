 ...
 */
public class AverageReducerDouble extends 
        Reducer<ArraySpec, AverageResultDouble, ArraySpec, AverageResultDouble> {

  private static final Log LOG = LogFactory.getLog(AverageReducerDouble.class);
   ...
   */
  public void reduce(ArraySpec key, Iterable<AverageResultDouble> values, 
                     Context context)
    ...
    AverageResultDouble aRes = new AverageResultDouble();

    for (AverageResultDouble value : values) {
      aRes.addAverageResultDouble(value);
    }
