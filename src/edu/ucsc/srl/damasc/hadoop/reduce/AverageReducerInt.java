 ...
 */
public class AverageReducerInt extends 
        Reducer<ArraySpec, AverageResultInt, ArraySpec, AverageResultInt> {

  private static final Log LOG = LogFactory.getLog(AverageReducerInt.class);
   ...
   */
  public void reduce(ArraySpec key, Iterable<AverageResultInt> values, 
                     Context context)
    ...
    for (AverageResultInt value : values) {
      aRes.addAverageResultInt(value);
    }
