 ...
 */
public class AverageReducerShort extends 
        Reducer<ArraySpec, AverageResultShort, ArraySpec, AverageResultShort> {

  private static final Log LOG = LogFactory.getLog(AverageReducerShort.class);
   ...
   */
  public void reduce(ArraySpec key, Iterable<AverageResultShort> values, 
                     Context context)
    ...
    for (AverageResultShort value : values) {
      aRes.addAverageResultShort(value);
    }
